...
- Event также в Angular встроенный класс. Надо следить за тем, что применяется именно наш интерфейс Event

- чтобы найти emoji Win + . (или код '\01F382')


- адаптивность медиа запросы (@media (min-width: 768px)) и пишем стили под это расшение заново
- гибкие единицы измерения (%, vw, vh) помогают элементам адаптироваться к разным размерам экрана


### Настройка Chrome на установку pwa без ssl
