import {
  ...
  transition,
  trigger
} from "./chunk-A4HYANNS.js";
import {
  CommonModule,
  NgForOf,
  NgIf,
  NgTemplateOutlet
} from "./chunk-7UYMU7BA.js";
import {
...
var require_graph = __commonJS({
  "node_modules/graphlib/lib/graph.js"(exports, module) {
    ...
    function incrementOrInitEntry(map4, k2) {
      if (map4[k2]) {
        map4[k2]++;
      } else {
        map4[k2] = 1;
    ...
    function decrementOrRemoveEntry(map4, k2) {
      if (!--map4[k2]) {
        delete map4[k2];
      }
    }
...
var require_util = __commonJS({
  "node_modules/dagre/lib/util.js"(exports, module) {
    ...
    function intersectRect(rect, point6) {
      var x4 = rect.x;
      var y4 = rect.y;
      var dx = point6.x - x4;
      var dy = point6.y - y4;
    ...
    var Configuration = function() {
      function Configuration2(n, edges, linkAccessor, rootGroup) {
        ...
        edges.forEach(function(e) {
          var s2 = _this.modules[linkAccessor.getSourceIndex(e)], t = _this.modules[linkAccessor.getTargetIndex(e)], type = linkAccessor.getType(e);
          s2.outgoing.add(type, t);
          t.incoming.add(type, s2);
        });
      }
      ...
      Configuration2.prototype.merge = function(a3, b, k2) {
        if (k2 === void 0) {
          k2 = 0;
        }
        var inInt = a3.incoming.intersection(b.incoming), outInt = a3.outgoing.intersection(b.outgoing);
        var children2 = new ModuleSet();
        children2.add(a3);
        children2.add(b);
        var m2 = new Module(this.modules.length, outInt, inInt, children2);
        this.modules.push(m2);
        var update = function(s2, i, o) {
          s2.forAll(function(ms, linktype) {
            ms.forAll(function(n) {
              var nls = n[i];
              nls.add(linktype, m2);
              nls.remove(linktype, a3);
              nls.remove(linktype, b);
              a3[o].remove(linktype, n);
      ...
      Configuration2.prototype.greedyMerge = function() {
        for (var i = 0; i < this.roots.length; ++i) {
          ...
          var ms = this.rootMerges(i).sort(function(a3, b) {
            return a3.nEdges == b.nEdges ? a3.id - b.id : a3.nEdges - b.nEdges;
          });
          var m2 = ms[0];
      ...
      Configuration2.prototype.nEdges = function(a3, b) {
        var inInt = a3.incoming.intersection(b.incoming), outInt = a3.outgoing.intersection(b.outgoing);
      ...
      Configuration2.prototype.getGroupHierarchy = function(retargetedEdges) {
        ...
        es.forEach(function(e) {
          var a3 = _this.modules[e.source];
          var b = _this.modules[e.target];
          retargetedEdges.push(new PowerEdge(typeof a3.gid === "undefined" ? e.source : groups2[a3.gid], typeof b.gid === "undefined" ? e.target : groups2[b.gid], e.type));
        });
        return groups2;
      };
...
var require_linklengths = __commonJS({
  "node_modules/webcola/dist/src/linklengths.js"(exports) {
    ...
    function unionCount(a3, b) {
      var u = {};
      for (var i in a3) u[i] = {};
      for (var i in b) u[i] = {};
      return Object.keys(u).length;
    }
    function intersectionCount(a3, b) {
      var n = 0;
      for (var i in a3) if (typeof b[i] !== "undefined") ++n;
      return n;
    }
    ...
    function computeLinkLengths(links, w, f, la) {
      ...
      links.forEach(function(l) {
        var a3 = neighbours[la.getSourceIndex(l)];
        var b = neighbours[la.getTargetIndex(l)];
        la.setLength(l, 1 + w * f(a3, b));
      });
    }
    function symmetricDiffLinkLengths(links, la, w) {
      ...
      computeLinkLengths(links, w, function(a3, b) {
        return Math.sqrt(unionCount(a3, b) - intersectionCount(a3, b));
      }, la);
    }
    ...
    function jaccardLinkLengths(links, la, w) {
      ...
      computeLinkLengths(links, w, function(a3, b) {
        return Math.min(Object.keys(a3).length, Object.keys(b).length) < 1.1 ? 0 : intersectionCount(a3, b) / unionCount(a3, b);
      }, la);
    }
...
var require_descent = __commonJS({
  "node_modules/webcola/dist/src/descent.js"(exports) {
    ...
    var Descent = function() {
      ...
      Descent2.prototype.computeDerivatives = function(x4) {
        ...
        for (var u = 0; u < numNodes; ++u) {
          for (i = 0; i < this.k; ++i) {
            ...
            var q = m2 - f;
            var a3 = Math.abs(f);
            var dx = a3 <= 0.5 ? xiu - q * g : xiu > 0 ? xiu - (q + 1) * g : xiu - (q - 1) * g;
            if (-r < dx && dx <= r) {
              if (this.scaleSnapByMaxH) {
                this.g[i][u] += maxH * k2 * dx;
                this.H[i][u][u] += maxH * k2;
              } else {
                this.g[i][u] += k2 * dx;
                this.H[i][u][u] += k2;
              }
      ...
      Descent2.dotProd = function(a3, b) {
        var x4 = 0, i = a3.length;
        while (i--) x4 += a3[i] * b[i];
        return x4;
      };
      ...
      Descent2.copy = function(a3, b) {
        var m2 = a3.length, n = b[0].length;
        for (var i = 0; i < m2; ++i) {
          for (var j = 0; j < n; ++j) {
            b[i][j] = a3[i][j];
          }
      ...
      Descent2.mid = function(a3, b, m2) {
        Descent2.mApply(a3.length, a3[0].length, function(i, j) {
          return m2[i][j] = a3[i][j] + (b[i][j] - a3[i][j]) / 2;
        });
      };
  ...
  "node_modules/webcola/dist/src/vpsc.js"(exports) {
    ...
    var Blocks = function() {
      ...
      Blocks2.prototype.cost = function() {
        var sum3 = 0, i = this.list.length;
        while (i--) sum3 += this.list[i].cost();
        return sum3;
      };
  ...
  "node_modules/webcola/dist/src/rectangle.js"(exports) {
    ...
    var Rectangle = function() {
      ...
      Rectangle2.lineIntersection = function(x1, y1, x22, y22, x32, y32, x4, y4) {
        ...
        var dx31 = x1 - x32, dy31 = y1 - y32, numa = dx34 * dy31 - dy34 * dx31, a3 = numa / denominator, numb = dx12 * dy31 - dy12 * dx31, b = numb / denominator;
        if (a3 >= 0 && a3 <= 1 && b >= 0 && b <= 1) {
          return {
            x: x1 + a3 * dx12,
            y: y1 + a3 * dy12
          };
    ...
    function makeRBTree() {
      return new rbtree_1.RBTree(function(a3, b) {
        return a3.pos - b.pos;
      });
    }
    var xRect = {
    ...
    function generateGroupConstraints(root2, f, minSep, isContained) {
      ...
      if (isContained) {
        var b = root2.bounds, c2 = f.getCentre(b), s2 = f.getSize(b) / 2, open = f.getOpen(b), close = f.getClose(b), min3 = c2 - s2 + padding / 2, max3 = c2 + s2 - padding / 2;
  ...
  "node_modules/webcola/dist/src/shortestpaths.js"(exports) {
    ...
    var Calculator = function() {
      ...
      Calculator2.prototype.PathFromNodeToNodeWithPrevCost = function(start2, end, prevCost) {
        var q = new pqueue_1.PriorityQueue(function(a3, b) {
          return a3.d <= b.d;
...
var require_geom = __commonJS({
  "node_modules/webcola/dist/src/geom.js"(exports) {
    ...
    function ConvexHull(S) {
      var P = S.slice(0).sort(function(a3, b) {
        return a3.x !== b.x ? b.x - a3.x : b.y - a3.y;
      });
      var n = S.length, i;
      var minmin = 0;
      var xmin = P[0].x;
    ...
    function clockwiseRadialSweep(p, P, f) {
      P.slice(0).sort(function(a3, b) {
        return Math.atan2(a3.y - p.y, a3.x - p.x) - Math.atan2(b.y - p.y, b.x - p.x);
      }).forEach(f);
    }
    ...
    function Rtangent_PointPolyC(P, V) {
      ...
      for (a3 = 0, b = n; ; ) {
        if (b - a3 === 1) if (above(P, V[a3], V[b])) return a3;
        else return b;
        c2 = Math.floor((a3 + b) / 2);
        dnC = below(P, V[c2 + 1], V[c2]);
        if (dnC && !above(P, V[c2 - 1], V[c2])) return c2;
        upA = above(P, V[a3 + 1], V[a3]);
        if (upA) {
          if (dnC) b = c2;
          else {
            if (above(P, V[a3], V[c2])) b = c2;
            else a3 = c2;
          }
        } else {
          if (!dnC) a3 = c2;
          else {
            if (below(P, V[a3], V[c2])) b = c2;
            else a3 = c2;
          }
        }
      }
    ...
    function Ltangent_PointPolyC(P, V) {
      ...
      for (a3 = 0, b = n; ; ) {
        if (b - a3 === 1) if (below(P, V[a3], V[b])) return a3;
        else return b;
        c2 = Math.floor((a3 + b) / 2);
        dnC = below(P, V[c2 + 1], V[c2]);
        if (above(P, V[c2 - 1], V[c2]) && !dnC) return c2;
        dnA = below(P, V[a3 + 1], V[a3]);
        if (dnA) {
          if (!dnC) b = c2;
          else {
            if (below(P, V[a3], V[c2])) b = c2;
  ...
  "node_modules/webcola/dist/src/handledisconnected.js"(exports) {
    ...
    function applyPacking(graphs, w, h, node_size, desired_ratio, centerGraph) {
      ...
      function apply(data, desired_ratio2) {
        ...
        var curr_best = 0;
        data.sort(function(a3, b) {
          return b.height - a3.height;
        });
        min_width = data.reduce(function(a3, b) {
          return a3.width < b.width ? a3.width : b.width;
        });
  ...
  "node_modules/webcola/dist/src/layout.js"(exports) {
    ...
    var Layout = function() {
      ...
      Layout2.prototype.start = function(initialUnconstrainedIterations, initialUserConstraintIterations, initialAllConstraintsIterations, gridSnapIterations, keepRunning, centerGraph) {
        ...
        this._descent = new descent_1.Descent([x4, y4], D2);
        this._descent.locks.clear();
        for (var i = 0; i < n; ++i) {
          var o = this._nodes[i];
          if (o.fixed) {
    ...
    var GridRouter = function() {
      function GridRouter2(originalnodes, accessor, groupPadding) {
        ...
        lines.forEach(function(l, li) {
          ...
          var delta = function(a3, b) {
            return isHoriz ? b.x - a3.x : b.y - a3.y;
          };
          l.verts.sort(delta);
      ...
      GridRouter2.prototype.avg = function(a3) {
        return a3.reduce(function(x4, y4) {
          return x4 + y4;
        }) / a3.length;
      };
      ...
      GridRouter2.prototype.midPoints = function(a3) {
        var gap = a3[1] - a3[0];
        var mids = [a3[0] - gap / 2];
        for (var i = 1; i < a3.length; i++) {
          mids.push((a3[i] + a3[i - 1]) / 2);
        }
        mids.push(a3[a3.length - 1] + gap / 2);
        return mids;
      };
      ...
      GridRouter2.prototype.findAncestorPathBetween = function(a3, b) {
        var aa = this.findLineage(a3), ba = this.findLineage(b), i = 0;
        while (aa[i] === ba[i]) i++;
        return {
      ...
      GridRouter2.prototype.siblingObstacles = function(a3, b) {
        var _this = this;
        var path2 = this.findAncestorPathBetween(a3, b);
        var lineageLookup = {};
      ...
      GridRouter2.getSegmentSets = function(routes, x4, y4) {
        ...
        vsegments.sort(function(a3, b) {
          return a3[0][x4] - b[0][x4];
        });
        var vsegmentsets = [];
        var segmentset = null;
      ...
      GridRouter2.nudgeSegs = function(x4, y4, routes, segments, leftOf, gap) {
        ...
        vs.forEach(function(v, i2) {
          ...
          if (s3.i > 0) route[s3.i - 1][1][x4] = pos;
          if (s3.i < route.length - 1) route[s3.i + 1][0][x4] = pos;
        });
      };
        ...
        for (var i = 0; i < vsegmentsets.length; i++) {
          ...
          for (var j = 0; j < ss.segments.length; j++) {
            ...
            events.push({
              type: 0,
              s: s2,
              pos: Math.min(s2[0][y4], s2[1][y4])
            });
            events.push({
              type: 1,
              s: s2,
              pos: Math.max(s2[0][y4], s2[1][y4])
            });
          }
          events.sort(function(a3, b) {
            return a3.pos - b.pos + a3.type - b.type;
          });
          var open = [];
          var openCount = 0;
      ...
      GridRouter2.isLeft = function(a3, b, c2) {
        return (b.x - a3.x) * (c2.y - a3.y) - (b.y - a3.y) * (c2.x - a3.x) <= 0;
      };
      ...
      GridRouter2.makeSegments = function(path2) {
        ...
        var isStraight = function(a4, b10, c3) {
          return Math.abs((b10.x - a4.x) * (c3.y - a4.y) - (b10.y - a4.y) * (c3.x - a4.x)) < 1e-3;
        };
        var segments = [];
        var a3 = copyPoint(path2[0]);
        for (var i = 1; i < path2.length; i++) {
          var b = copyPoint(path2[i]), c2 = i < path2.length - 1 ? path2[i + 1] : null;
          if (!c2 || !isStraight(a3, b, c2)) {
            segments.push([a3, b]);
            a3 = b;
          }
        }
      ...
      GridRouter2.prototype.route = function(s2, t) {
        ...
        var bendPenalty = function(u2, v2, w) {
          var a3 = _this.verts[u2], b = _this.verts[v2], c2 = _this.verts[w];
          var dx = Math.abs(c2.x - a3.x), dy = Math.abs(c2.y - a3.y);
          if (a3.node === source && a3.node === b.node || b.node === target && b.node === c2.node) return 0;
...
var amplitude = 1;
var period = 0.3;
var elasticIn = function custom14(a3, p) {
  var s2 = Math.asin(1 / (a3 = Math.max(1, a3))) * (p /= tau3);
  function elasticIn2(t) {
    return a3 * tpmt(- --t) * Math.sin((s2 - t) / p);
  }
  elasticIn2.amplitude = function(a4) {
    return custom14(a4, p * tau3);
  };
  elasticIn2.period = function(p2) {
    return custom14(a3, p2);
  };
  return elasticIn2;
}(amplitude, period);
var elasticOut = function custom15(a3, p) {
  var s2 = Math.asin(1 / (a3 = Math.max(1, a3))) * (p /= tau3);
  function elasticOut2(t) {
    return 1 - a3 * tpmt(t = +t) * Math.sin((t + s2) / p);
  }
  elasticOut2.amplitude = function(a4) {
    return custom15(a4, p * tau3);
  };
  elasticOut2.period = function(p2) {
    return custom15(a3, p2);
  };
  return elasticOut2;
}(amplitude, period);
var elasticInOut = function custom16(a3, p) {
  var s2 = Math.asin(1 / (a3 = Math.max(1, a3))) * (p /= tau3);
  function elasticInOut2(t) {
    return ((t = t * 2 - 1) < 0 ? a3 * tpmt(-t) * Math.sin((s2 - t) / p) : 2 - a3 * tpmt(t) * Math.sin((s2 + t) / p)) / 2;
  }
  elasticInOut2.amplitude = function(a4) {
    return custom16(a4, p * tau3);
  };
...
function decompose_default(a3, b, c2, d, e, f) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a3 * a3 + b * b)) a3 /= scaleX, b /= scaleX;
  if (skewX = a3 * c2 + b * d) c2 -= a3 * skewX, d -= b * skewX;
  if (scaleY = Math.sqrt(c2 * c2 + d * d)) c2 /= scaleY, d /= scaleY, skewX /= scaleY;
  if (a3 * d < b * c2) a3 = -a3, b = -b, skewX = -skewX, scaleX = -scaleX;
  return {
    translateX: e,
    translateY: f,
...
function interpolate_default(a3, b) {
  var c2;
  return (typeof b === "number" ? number_default : b instanceof color ? rgb_default : (c2 = color(b)) ? (b = c2, rgb_default) : string_default)(a3, b);
}
...
function link_default(links) {
  var id3 = index2, strength = defaultStrength, strengths, distance = constant_default4(30), distances, nodes, count2, bias, random, iterations = 1;
  if (links == null) links = [];
...
var GraphComponent = class _GraphComponent {
  ...
  onZoom($event, direction) {
    ...
    if (this.panOnZoom === true && $event) {
      ...
      const point6 = svg.createSVGPoint();
      point6.x = mouseX;
      point6.y = mouseY;
      const svgPoint = point6.matrixTransform(svgGroup.getScreenCTM().inverse());
